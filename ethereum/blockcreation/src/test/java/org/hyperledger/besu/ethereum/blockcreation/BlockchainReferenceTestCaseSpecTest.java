...
class BlockchainReferenceTestCaseSpecTest {
  ...
  void getValidTxs() {
    ...
    final JavaType javaType =
            objectMapper
                    .getTypeFactory()
                    .constructParametricType(JsonTestParameters.JsonTestCaseReader.class, BlockchainReferenceTestCaseSpec.class);
    JsonTestParameters.JsonTestCaseReader<BlockchainReferenceTestCaseSpec> blockchainReferenceTestCaseSpec;
    try {
      blockchainReferenceTestCaseSpec = objectMapper.readValue(jsonValid, javaType);
    } catch (final IOException e) {
      throw new RuntimeException(
              "Error parsing test case json.", e);
    }

    Assertions.assertEquals(1, blockchainReferenceTestCaseSpec.testCaseSpecs.size());
    Assertions.assertEquals(1, blockchainReferenceTestCaseSpec.testCaseSpecs.get("Call1MB1024Calldepth_d0g0v0_London").getCandidateBlocks().length);
    Assertions.assertEquals(true, blockchainReferenceTestCaseSpec.testCaseSpecs.get("Call1MB1024Calldepth_d0g0v0_London").getCandidateBlocks()[0].areAllTransactionsValid());
  }
  ...
  void getInValidTxs() {
    ...
    Assertions.assertEquals(1, blockchainReferenceTestCaseSpec.testCaseSpecs.size());
    Assertions.assertEquals(1, blockchainReferenceTestCaseSpec.testCaseSpecs.get("ValueOverflow_d0g0v0_EIP150").getCandidateBlocks().length);
    Assertions.assertEquals(false, blockchainReferenceTestCaseSpec.testCaseSpecs.get("ValueOverflow_d0g0v0_EIP150").getCandidateBlocks()[0].areAllTransactionsValid());
  }
